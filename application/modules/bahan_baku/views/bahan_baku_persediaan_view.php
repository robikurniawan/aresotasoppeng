...
<section class="content-header">
  <h1> Data Persediaan Bahan Baku </h1>
  <ol class="breadcrumb">
            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class="row" style="margin-bottom:20px;">
                        <div class="col-md-6">
                            <h3 class="box-title">Data Persediaan Bahan Baku  </h3>
                        </div>
                        <div class="col-md-6">
                            <div class="pull-right">
                                ...
                                ?>
                                    <a href="<?= base_url()?>bahan_baku/cetak_bahan_baku" target="blank" class="btn btn-success"><i class="fa fa-print"></i> Cetak </a>
                                <?php
                                    }
                                ?>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                ...
                <input type="hidden" name="jenis" value="persediaan" id="">
